  ...
  <?php
    ...
    try{
      ...
      foreach($stmt as $crow){
        $subtotal = $crow['product_price'] * $crow['qty'];
        $total += $subtotal;
      }
    }
      ...
      <div class="row">
        ...
        <form class="checkout-form" id="checkout-form" method="POST">
          ...
          <div class="block">
            ...
            <p id="stripe-btn"><script
              src="https://checkout.stripe.com/checkout.js" id="stripe-pay" class="stripe-button"
              data-key="<?=$publishKey?>"
            ...
            <button type="button" class="btn btn-primary mt-3 checkout-btn" id="checkout-btn" name="cod">Place Order</button>
